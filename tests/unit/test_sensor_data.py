...
class TestSensorEventInsertion(unittest.TestCase):
    ...
    def test_sensor_event_insertion(self, mock_close_db_connection, mock_get_db_connection):
        ...
        insert_sensor_data(mock_cursor, timestamp, temperature, sensor_id, status, other_data)
        ...
        expected_query = (
            "INSERT INTO sensor_events (timestamp, temperature, sensor_id, status, other_data) VALUES (%s, %s, %s, %s, %s)"
        )
