...
def insert_ci_metrics(cursor, timestamp, build_success_rate, average_build_duration, tests_executed, test_failure_rate):
    ...
    query = """
        ...
        VALUES (%s, %s, %s, %s, %s)
    """
    cursor.execute(query, (timestamp, build_success_rate, average_build_duration, tests_executed, test_failure_rate))
